...
(function attachRemoteLabI18n(root) {
  ...
  const translations = {
    en: {
      ...
      "settings.language.note": "Auto follows the current browser language. You can override it here for debugging or to keep this browser on a fixed UI language.",
      ...
      "settings.sessionPresentation.note": "Internal-only display control for the selected session. Use top-down reading for welcome or example sessions, and keep normal work on the latest turn.",
      "settings.sessionPresentation.noSession": "Select a session first, then choose how it should open.",
      "settings.sessionPresentation.ownerOnly": "Only the owner can manage how sessions open.",
      "settings.sessionPresentation.currentSession": "Current session",
      "settings.sessionPresentation.entryModeAriaLabel": "Choose how the current session opens",
      "settings.sessionPresentation.entryMode.resume": "Default: latest turn",
      "settings.sessionPresentation.entryMode.read": "Start from top",
      ...
      "modal.close": "Close",
      "modal.newSessionTitle": "New Session",
      "modal.folder": "Project Path",
      "modal.folderPlaceholder": "/path/to/project",
      "modal.tool": "Agent",
      "modal.sessionName": "Name (optional)",
      "modal.sessionNamePlaceholder": "e.g. Fix auth bug",
      "modal.cancel": "Cancel",
      "modal.create": "Create",
      "modal.noTools": "No agents available",
      ...
      "workspace.selectAriaLabel": "Select workspace",
      "workspace.add": "Add workspace",
      "workspace.newNamePrompt": "Enter workspace name:",
    ...
    "zh-CN": {
      ...
      "settings.language.note": "默认会跟随当前浏览器语言。你也可以在这里为当前浏览器强制切换，用来调试或固定当前浏览器的界面语言。",
      ...
      "settings.sessionPresentation.note": "只影响内部展示逻辑。欢迎页或示例会话适合从顶部开始读；普通工作会话继续停在最新一轮。",
      "settings.sessionPresentation.noSession": "先选中一个会话，再设置它的打开方式。",
      "settings.sessionPresentation.ownerOnly": "只有 owner 可以管理会话打开方式。",
      "settings.sessionPresentation.currentSession": "当前会话",
      "settings.sessionPresentation.entryModeAriaLabel": "选择当前会话的打开方式",
      "settings.sessionPresentation.entryMode.resume": "默认：最新一轮",
      "settings.sessionPresentation.entryMode.read": "从顶部开始",
      ...
      "modal.close": "关闭",
      "modal.newSessionTitle": "新建会话",
      "modal.folder": "项目路径",
      "modal.folderPlaceholder": "/path/to/project",
      "modal.tool": "Agent",
      "modal.sessionName": "名称（可选）",
      "modal.sessionNamePlaceholder": "例如：修复认证问题",
      "modal.cancel": "取消",
      "modal.create": "创建",
      "modal.noTools": "没有可用的 Agent",
      "login.tagline": "登录后继续",
      ...
      "workspace.selectAriaLabel": "选择工作空间",
      "workspace.add": "添加工作空间",
      "workspace.newNamePrompt": "输入工作空间名称：",
