...
assert.match(context, /default dispatch layer/);
...
assert.match(context, /2\+ independently completable asks/);
assert.match(context, /could plausibly be its own session title/);
assert.match(context, /reviewing the current backlog and deciding whether the TODO process needs a stable SOP/);
